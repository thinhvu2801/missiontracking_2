{{-- resources/views/agency_group/create.blade.php (FORM ONLY - no layout) --}}
<!DOCTYPE html>
<html lang="vi">
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>Thêm nhóm cơ quan</title>
    ...
    <div class="cardx">
      <div class="head">
        <div class="title">
          ...
          <div>
            <h3>Thêm nhóm cơ quan</h3>
            <p>Tạo nhóm mới để gom cơ quan theo cây thư mục.</p>
          </div>
        </div>
      ...
      <div class="body">
        ...
        <form method="POST" action="{{ route('agency-groups.store') }}">
          @csrf
          ...
          <div class="form-group">
            ...
            <input id="group_name" name="group_name" class="form-control" required
                   value="{{ old('group_name') }}" placeholder="Ví dụ: Khối chuyên môn / Khối hành chính...">
          </div>

          <div class="form-group">
            <label for="description">Mô tả</label>
            <textarea id="description" name="description" class="form-control" rows="3"
                      placeholder="Ghi chú ngắn (không bắt buộc)">{{ old('description') }}</textarea>
          </div>

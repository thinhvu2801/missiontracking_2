...
@section('title', 'Thêm nguyên nhân trễ hạn')
    ...
    <div class="col-lg-12">
        <div class="ibox">
            <div class="ibox-title">
                <h2>Thêm nguyên nhân</h2>
            </div>

            @include('partials.error')

            <div class="ibox-content">
                <form method="POST" action="{{ route('delay-reasons.store') }}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('reason_name') }}"
                               placeholder="Nhập tên nguyên nhân"
                               required>
